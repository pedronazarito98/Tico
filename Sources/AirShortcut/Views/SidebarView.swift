...
struct SidebarView: View {
    ...
    private let primarySections: [AirShortcutSection] = [
        .overview,
        .permissions,
        .rules,
        .profiles
    ]
    private let toolSections: [AirShortcutSection] = [
        .library,
        .laboratory,
        .metrics,
        .log
    ...
    @ViewBuilder
    private func navigationRow(for section: AirShortcutSection) -> some View {
        if section == .rules {
            RuleSidebarSection(
                selection: $selection,
